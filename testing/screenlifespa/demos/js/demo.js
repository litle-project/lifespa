$(document).ready(function(){
	...
	.anythingSlider({
		...
		navigationFormatter : function(i, panel){
			return ['Welcome', 'Quote', 'Image', 'Quote #2', 'Schedule'][i - 1];
		}
	})
	.anythingSliderFx({
		// base FX definitions
		// '.selector' : [ 'effect(s)', 'distance/size', 'time', 'easing' ] - 'time' and 'easing' are optional parameters
		'.quoteSlide'         : [ 'top', '500px', '2000', 'easeOutElastic' ],
		'.expand'             : [ 'expand', '10%', '1000', 'easeOutBounce' ],
		'.textSlide h3'       : [ 'top left', '200px', '2000', 'easeOutCirc' ],
