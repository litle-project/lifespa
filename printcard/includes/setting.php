...
if (SETTING_TYPE=="production"){
	...
	define("DBUSER","root");
	define("DBPASS","root");
	define("WEBROOT","http://".$_SERVER['SERVER_NAME']."/printcard/");
	define("DATAROOT","http://".$_SERVER['SERVER_NAME']."/printcard/");
}
else
{
	define("DBHOST","localhost");
	...
	define("DBUSER","root");
	define("DBPASS","root");
	//define("WEBROOT","http://lifespa.web.id:8088/");
	//define("DATAROOT","http://lifespa.web.id:8089/");
